...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#e0f7fa] via-white to-[#ede7f6] overflow-x-hidden font-sans">
      ...
      {/* Headline Section */}
      <section className="relative flex flex-col md:flex-row items-start justify-between px-4 md:px-16 mt-8 md:mt-16 w-full max-w-[1400px] mx-auto z-10 min-h-[320px] md:min-h-[420px]">
        <div className="flex-1 flex flex-col gap-4 max-w-full md:max-w-2xl pt-4 md:pt-16">
      ...
      <div className="flex md:hidden justify-center items-center flex-wrap gap-2 mt-6 px-4 z-20">
      ...
      {/* Tech Stack Bar */}
      <div
        className="fixed left-1/2 -translate-x-1/2 bottom-4 md:bottom-8 w-[95vw] md:w-[480px] max-w-[98vw] px-4 md:px-8 py-3 bg-white rounded-3xl shadow-lg flex items-center justify-between z-30 backdrop-blur-md"
      >
